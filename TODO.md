...
* Floating sprite implementation for when Ness receives a phone call, similar to Mother 3's Transceiver. It should be made similar to how Capt. Strong does it in Onett.
* Verify turn variance from Mother 3, if it is indeed 25%, then it should be modified to match, since Mother 2/Earthbound has 50% variance.
